...
public record Instrument(int sampleNumber, int pitch, int effect, int effectArgument) {

    public Instrument(int sampleNumber, int pitch, int effect, int effectArgument) {
