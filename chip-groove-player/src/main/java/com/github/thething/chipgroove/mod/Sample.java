...
public final class Sample {
    ...
    /**
     * Start of sample repeat offset in bytes. Once the sample has been played all the way through, it will loop if the
     * repeat length is greater than one. It repeats by jumping to this position in the sample and playing for the
     * repeat length, then jumping back to this position, and playing for the repeat length, etc.
     */
    private final int loopStart;

    /**
     * Length of sample repeat in bytes. Only loop if greater than 2 (due to conversion from words to bytes).
     */
